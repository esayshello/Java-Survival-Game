/**
 *This program displays the congratulatory screen when the user completes the maze. 
 *
 *<h2>Course Info:<h2>
...
public class CongratulationMaze
{
   ...
   /**
    * {@link CongratulationMaze} constructor.
...
class Drawing extends JComponent 
   {
      ...
      /**
       *Displays graphics for congratulation screen (calls all methods necessary)
       *      
      ...
      {  
       ...
       public void ogBackground(Graphics g)
       {
         ...
         /**Text*/
         g.drawString("You escaped the maze!",220,140);
         g.drawString("CLICK MAIN MENU TO CONTINUE!",100,250);
