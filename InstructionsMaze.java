/**
 *This program displays the instructions screen when the user wants to play the maze. 
 *
 *<h2>Course Info:<h2>
...
public class InstructionsMaze
{
   ...
   /**
    * {@link InstructionsMaze} constructor.
...
class Drawing extends JComponent 
   {
      ...
      {  
       ...
       public void ogBackground(Graphics g)
       {
         ...
         /**Text*/
         g.drawString("You are trapped in a maze! Try to find your",60,140);
         g.drawString("way out. Use the arrow keys to move around.",60,190); 
         g.drawString("Remember to stay on the path! Also,",60,240);
         g.drawString("you must collect all the items that will",60,290);
         g.drawString("help you survive the hot day in order",60,340);
         g.drawString("to complete the maze.",60,390); 
         g.drawString("CLICK ANYWHERE TO CONTINUE!",100,450);
